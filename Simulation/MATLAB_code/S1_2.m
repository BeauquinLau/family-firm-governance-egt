...
% linearizes the system at this point, and plots the resulting manifolds.
...
for i = 1:length(n_values)
    ...
    text(y1_val - 0.1, y2_val - 0.01, 'E_5', 'FontSize', 12, 'VerticalAlignment', 'bottom', 'HorizontalAlignment', 'left');
end
...
outputFileName = fullfile(outputPath, 'F1_2.eps');
