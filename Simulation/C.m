...
for k = 1:length(n_values)
    ...
    % Solve the system of ODEs from the initial point 'C' [0.8, 0.85]
    [~, Y] = ode45(ode_function_handle, [0 1000], [0.8, 0.85]);
...
% Mark the initial point 'C'
text(0.8-0.04, 0.85-0.03, 'C', 'FontSize', 13, ...
    'VerticalAlignment', 'bottom', 'HorizontalAlignment', 'left');
...
outputFileName = fullfile(outputPath, 'F4_3.eps');
