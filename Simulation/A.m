...
for k = 1:length(n_values)
    ...
    % Solve the system of ODEs from the initial point [0.4, 0.3]
    [~, Y] = ode45(ode_function_handle, [0 1000], [0.4, 0.3]);
...
% Mark the initial point 'A'
text(0.4-0.03, 0.31, 'A', 'FontSize', 13, ...
    'VerticalAlignment', 'bottom', 'HorizontalAlignment', 'left');
...
outputFileName = fullfile(outputPath, 'F4_1.eps');
