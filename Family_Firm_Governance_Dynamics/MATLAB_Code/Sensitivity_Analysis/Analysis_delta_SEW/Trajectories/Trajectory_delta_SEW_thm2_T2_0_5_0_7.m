%%% TRAJECTORY_DELTA_SEW_THM2_T2_0.5_0.7.M - Trajectory Analysis for a Flipping Initial Point (Theorem 2) %%%
clear; clc; close all;
...
%%% === 4. PLOT ANNOTATIONS
%%% ===================================================================
% Plot the initial starting point 'T2'
plot(initial_condition(1), initial_condition(2), 'ks', 'MarkerSize', 12, 'MarkerFaceColor', 'r');
text(initial_condition(1), initial_condition(2) - 0.04, '$T_2$', 'FontSize', 12, 'HorizontalAlignment', 'center', 'Interpreter', 'latex');
...
title({'Trajectory Sensitivity to $\Delta_{SEW}$ from Flipping Initial Point $T_2$ (0.5, 0.7)', ...
       '--- Theorem 2'}, ...
...
outputFileName = 'Trajectory_delta_SEW_thm2_T2_0.5_0.7.pdf';
