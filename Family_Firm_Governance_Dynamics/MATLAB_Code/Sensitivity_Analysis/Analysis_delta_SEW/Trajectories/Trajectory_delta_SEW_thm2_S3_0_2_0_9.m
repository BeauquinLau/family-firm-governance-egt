%%% TRAJECTORY_ANALYSIS_S3_SEW_THM2.M - Trajectory Analysis for a Fixed Initial Point vs. DELTA_SEW (Theorem 2) %%%
clear; clc; close all;
...
%%% ===================================================================
% The valid range for delta_SEW for Theorem 2 is [0, 3.648)
...
%%% === 4. PLOT ANNOTATIONS
%%% ===================================================================
% Plot the initial starting point 'S3'
plot(initial_condition(1), initial_condition(2), 'ks', 'MarkerSize', 12, 'MarkerFaceColor', 'r');
text(initial_condition(1), initial_condition(2) - 0.04, '$S_3$', 'FontSize', 12, 'HorizontalAlignment', 'center', 'Interpreter', 'latex');
...
title({'Trajectory Sensitivity to $\Delta_{SEW}$ from Stable Initial Point $S_3$ (0.2, 0.9)', '--- Theorem 2'},'Interpreter','latex', 'FontSize', 16);
grid on; box on;
...
outputFileName = 'Trajectory_delta_SEW_thm2_S3_0.2_0.9.pdf';
