%%% TRAJECTORY_DELTA_SEW_THM1_S2_0.6_0.5.M - Trajectory Analysis for Stable Point S2 %%%
clear; clc; close all;
...
%%% === 4. PLOT ANNOTATIONS
%%% ===================================================================
% Plot the initial starting point 'S2'
plot(initial_condition(1), initial_condition(2), 'ks', 'MarkerSize', 12, 'MarkerFaceColor', 'r');
text(initial_condition(1), initial_condition(2) + 0.04, '$S_2$', 'FontSize', 12, 'HorizontalAlignment', 'center', 'Interpreter', 'latex');
...
title({'Trajectory Sensitivity to $\Delta_{SEW}$ from Stable Initial Point $S_2$ (0.6, 0.5)',  '--- Theorem 1'},'Interpreter','latex', 'FontSize', 16);
grid on; box on;
...
outputFileName = 'Trajectory_delta_SEW_thm1_S2_0.6_0.5.pdf';
