%%% TRAJECTORY_DELTA_SEW_THM2_S4_0.6_0.4.M - Trajectory Analysis for a Fixed Initial Point (Theorem 2) %%%
clear; clc; close all;
...
%%% === 4. PLOT ANNOTATIONS
%%% ===================================================================
% Plot the initial starting point 'S4'
plot(initial_condition(1), initial_condition(2), 'ks', 'MarkerSize', 12, 'MarkerFaceColor', 'r');
text(initial_condition(1), initial_condition(2) + 0.04, '$S_4$', 'FontSize', 12, 'HorizontalAlignment', 'center', 'Interpreter', 'latex');
...
title({'Trajectory Sensitivity to $\Delta_{SEW}$ from Stable Initial Point $S_4$ (0.6, 0.4)', ...
       '--- Theorem 2'}, ...
...
outputFileName = 'Trajectory_delta_SEW_thm2_S4_0.6_0.4.pdf';
