%%% TRAJECTORY_N_THM1_T5_0.2_0.35.M - Trajectory Analysis for a Flipping Initial Point %%%
clear; clc; close all;
...
%%% ===================================================================
% The valid range for n for Theorem 1 is (0.02, 0.26)
n_values = 0.03:0.02:0.25; % Select a representative range of values for n
% Define the single initial condition for all trajectories
initial_condition = [0.2, 0.35];
...
%%% === 4. PLOT ANNOTATIONS
%%% ===================================================================
% Plot the initial starting point 'T_5'
plot(initial_condition(1), initial_condition(2), 'ks', 'MarkerSize', 12, 'MarkerFaceColor', 'r');
text(initial_condition(1), initial_condition(2) + 0.04, '$T_5$', 'FontSize', 12, 'HorizontalAlignment', 'center', 'Interpreter', 'latex');
...
title({'Trajectory Sensitivity to $n$ from Flipping Initial Point $T_5$ (0.2, 0.35)', '--- Theorem 1'},'Interpreter','latex', 'FontSize', 16);
grid on; box on;
...
outputFileName = 'Trajectory_n_thm1_T5_0.2_0.35.pdf';
