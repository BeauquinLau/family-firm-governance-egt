%%% TRAJECTORY_N_THM1_S9_0.3_0.1.M - Trajectory Analysis for a Fixed Initial Point %%%
clear; clc; close all;
...
%%% === 4. PLOT ANNOTATIONS
%%% ===================================================================
% Plot the initial starting point 'S_9'
plot(initial_condition(1), initial_condition(2), 'ks', 'MarkerSize', 12, 'MarkerFaceColor', 'r');
text(initial_condition(1), initial_condition(2) + 0.04, '$S_9$', 'FontSize', 12, 'HorizontalAlignment', 'center', 'Interpreter', 'latex');
...
title({'Trajectory Sensitivity to $n$ from Stable Initial Point $S_9$ (0.3, 0.1)', '--- Theorem 1'},'Interpreter','latex', 'FontSize', 16);
grid on; box on;
...
outputFileName = 'Trajectory_n_thm1_S9_0.3_0.1.pdf';
