%%% TRAJECTORY_N_THM2_S12_0.6_0.4.M - Trajectory Analysis for a Fixed Initial Point (Theorem 2) %%%
clear; clc; close all;
...
%%% === 4. PLOT ANNOTATIONS
%%% ===================================================================
% Plot the initial starting point 'S_{12}'
plot(initial_condition(1), initial_condition(2), 'ks', 'MarkerSize', 12, 'MarkerFaceColor', 'r');
text(initial_condition(1), initial_condition(2) + 0.04, '$S_{12}$', 'FontSize', 12, 'HorizontalAlignment', 'center', 'Interpreter', 'latex');
...
title({'Trajectory Sensitivity to $n$ from Stable Initial Point $S_{12}$ (0.6, 0.4)', '--- Theorem 2'},'Interpreter','latex', 'FontSize', 16);
grid on; box on;
...
outputFileName = 'Trajectory_n_thm2_S12_0.6_0.4.pdf';
