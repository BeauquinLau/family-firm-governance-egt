%%% TRAJECTORY_N_THM_R2_0.9237_0.8840.M - Trajectory Analysis for a Flipping Initial Point (Theorem 2) %%%
clear; clc; close all;
...
initial_condition = [0.9237, 0.8840];
...
%%% === 4. PLOT ANNOTATIONS
%%% ===================================================================
% Plot the initial starting point 'R_2'
plot(initial_condition(1), initial_condition(2), 'ks', 'MarkerSize', 12, 'MarkerFaceColor', 'r');
text(initial_condition(1), initial_condition(2) - 0.04, '$R_2$', 'FontSize', 12, 'HorizontalAlignment', 'center', 'Interpreter', 'latex');
...
title({'Trajectory Sensitivity to $n$ from Flipping Initial Point $R_2$ (0.9237, 0.8840)', ...
       '--- Theorem 2'}, ...
...
outputFileName = 'Trajectory_n_thm2_R2_0.9237_0.8840.pdf';
