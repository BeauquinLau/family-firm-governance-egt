%%% TRAJECTORY_N_THM2_T8_0.975740_0.942642.M - Trajectory Analysis for a Flipping Initial Point (Theorem 2) %%%
clear; clc; close all;
...
initial_condition = [0.975740, 0.942642];
...
%%% === 4. PLOT ANNOTATIONS
%%% ===================================================================
% Plot the initial starting point 'T_8'
plot(initial_condition(1), initial_condition(2), 'ks', 'MarkerSize', 12, 'MarkerFaceColor', 'r');
text(initial_condition(1), initial_condition(2) - 0.04, '$T_8$', 'FontSize', 12, 'HorizontalAlignment', 'center', 'Interpreter', 'latex');
...
title({'Trajectory Sensitivity to $n$ from Flipping Initial Point $T_8$ (0.975740, 0.942642)', ...
       '--- Theorem 2'}, ...
...
outputFileName = 'Trajectory_n_thm2_T8_0.975740_0.942642.pdf';
