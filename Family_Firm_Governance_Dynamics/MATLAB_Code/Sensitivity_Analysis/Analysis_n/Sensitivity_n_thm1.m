%%% SENSITIVITY_N_THM1.M - SENSITIVITY ANALYSIS FOR PARAMETER N %%%
clear; clc; close all;
%%% ===================================================================
...
f1 = 2.5; f_alpha = 1.0; f_PM = 1.2;
f_diff = f1 - f_alpha; % Pre-calculate for efficiency

%%% ===================================================================
%%% === 2. SIMULATION CONFIGURATION
%%% ===================================================================
% The valid range for n was derived as (0.02, 0.26)
n_values = 0.03:0.02:0.25; % Select a range of values for n to test
...
for i = 1:length(n_values)
    ...
    % Correct formulas for p* and q* from your S1_final_robust.m
...
plot(0.7, 0.1, 'ks', 'MarkerSize', 10, 'MarkerFaceColor', 'r', 'MarkerEdgeColor', 'k');
text(0.7, 0.1 + 0.04, '$R_1$', 'FontSize', 14, 'HorizontalAlignment', 'center', 'Interpreter', 'latex');

plot(0.3, 0.1, 'ks', 'MarkerSize', 10, 'MarkerFaceColor', 'r', 'MarkerEdgeColor', 'k');
text(0.3, 0.1 - 0.04, '$S_1$', 'FontSize', 14, 'HorizontalAlignment', 'center', 'Interpreter', 'latex');

plot(0.5, 0.4, 'ks', 'MarkerSize', 10, 'MarkerFaceColor', 'r', 'MarkerEdgeColor', 'k');
text(0.5, 0.4 + 0.04, '$S_2$', 'FontSize', 14, 'HorizontalAlignment', 'center', 'Interpreter', 'latex');

plot(0.2, 0.35, 'ks', 'MarkerSize', 10, 'MarkerFaceColor', 'r', 'MarkerEdgeColor', 'k');
text(0.2 + 0.02, 0.35 - 0.04, '$T_1$', 'FontSize', 14, 'HorizontalAlignment', 'right', 'Interpreter', 'latex');

plot(0.8, 0.06, 'ks', 'MarkerSize', 10, 'MarkerFaceColor', 'r', 'MarkerEdgeColor', 'k');
text(0.8, 0.06 + 0.04, '$T_2$', 'FontSize', 14, 'HorizontalAlignment', 'center', 'Interpreter', 'latex');
...
title('Sensitivity Analysis for Theorem 1: Locus of the Separatrix for varying $n$','Interpreter','latex', 'FontSize', 16);
grid on; box on;
...
outputFileName = 'Sensitivity_n_thm1.pdf';
