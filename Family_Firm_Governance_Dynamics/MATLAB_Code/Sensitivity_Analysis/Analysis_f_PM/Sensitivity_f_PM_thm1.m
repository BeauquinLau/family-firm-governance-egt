%%% SENSITIVITY_F_PM_THM1.M - SENSITIVITY ANALYSIS FOR PARAMETER F_PM %%%
clear; clc; close all;
...
%%% ===================================================================
% The valid range for f_PM was derived as (0.3, 2.62)
f_PM_values = 0.4:0.2:2.6; % Select a range of values for f_PM to test
...
plot(0.05, 0.05, 'ks', 'MarkerSize', 10, 'MarkerFaceColor', 'r', 'MarkerEdgeColor', 'k');
text(0.05 + 0.03, 0.05 - 0.02, '$S_5$', 'FontSize', 14, 'HorizontalAlignment', 'center', 'Interpreter', 'latex');
plot(0.6, 0.7, 'ks', 'MarkerSize', 10, 'MarkerFaceColor', 'r', 'MarkerEdgeColor', 'k');
text(0.6, 0.7 + 0.04, '$S_6$', 'FontSize', 14, 'HorizontalAlignment', 'center', 'Interpreter', 'latex');
plot(0.2, 0.3, 'ks', 'MarkerSize', 10, 'MarkerFaceColor', 'r', 'MarkerEdgeColor', 'k');
text(0.2 + 0.02, 0.3 - 0.04, '$T_3$', 'FontSize', 14, 'HorizontalAlignment', 'right', 'Interpreter', 'latex');

% Plot Fixed Points (for Theorem 1)
...
title('Sensitivity Analysis for Theorem 1: Locus of the Separatrix for varying $f_{PM}$','Interpreter','latex', 'FontSize', 16);
grid on; box on;
...
outputFileName = 'Sensitivity_f_PM_thm1.pdf';
