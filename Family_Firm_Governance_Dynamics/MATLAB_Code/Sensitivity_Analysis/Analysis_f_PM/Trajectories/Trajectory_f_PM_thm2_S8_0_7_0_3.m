%%% TRAJECTORY_F_PM_THM2_S8_0.7_0.3.M - Trajectory Analysis for Stable Point S8 vs. F_PM (Theorem 2) %%%
clear; clc; close all;
...
%%% === 4. PLOT ANNOTATIONS
%%% ===================================================================
% Plot the initial starting point 'S8'
plot(initial_condition(1), initial_condition(2), 'ks', 'MarkerSize', 12, 'MarkerFaceColor', 'r');
text(initial_condition(1), initial_condition(2) + 0.04, '$S_8$', 'FontSize', 12, 'HorizontalAlignment', 'center', 'Interpreter', 'latex');
...
title({'Trajectory Sensitivity to $f_{PM}$ from Stable Initial Point $S_8$ (0.7, 0.3)', '--- Theorem 2'},'Interpreter','latex', 'FontSize', 16);
grid on; box on;
...
outputFileName = 'Trajectory_f_PM_thm2_S8_0.7_0.3.pdf';
