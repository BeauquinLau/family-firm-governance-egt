%%% TRAJECTORY_F_PM_THM1_T3_0.2_0.3.M - Trajectory Analysis for Flipping Point T3 vs. F_PM %%%
clear; clc; close all;
...
%%% === 4. PLOT ANNOTATIONS
%%% ===================================================================
% Plot the initial starting point 'T3'
plot(initial_condition(1), initial_condition(2), 'ks', 'MarkerSize', 12, 'MarkerFaceColor', 'r');
text(initial_condition(1), initial_condition(2) + 0.04, '$T_3$', 'FontSize', 12, 'HorizontalAlignment', 'center', 'Interpreter', 'latex');
...
title({'Trajectory Sensitivity to $f_{PM}$ from Flipping Initial Point $T_3$ (0.2, 0.3)', '--- Theorem 1'},'Interpreter','latex', 'FontSize', 16);
grid on; box on;
...
outputFileName = 'Trajectory_f_PM_thm1_T3_0.2_0.3.pdf';
