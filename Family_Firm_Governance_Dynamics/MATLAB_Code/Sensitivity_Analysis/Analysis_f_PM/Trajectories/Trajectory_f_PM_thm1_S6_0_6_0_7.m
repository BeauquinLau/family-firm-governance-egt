%%% TRAJECTORY_F_PM_THM1_S6_0.6_0.7.M - Trajectory Analysis for Stable Point S6 vs. F_PM %%%
clear; clc; close all;
...
%%% === 4. PLOT ANNOTATIONS
%%% ===================================================================
% Plot the initial starting point 'S6'
plot(initial_condition(1), initial_condition(2), 'ks', 'MarkerSize', 12, 'MarkerFaceColor', 'r');
text(initial_condition(1), initial_condition(2) + 0.04, '$S_6$', 'FontSize', 12, 'HorizontalAlignment', 'center', 'Interpreter', 'latex');
...
title({'Trajectory Sensitivity to $f_{PM}$ from Stable Initial Point $S_6$ (0.6, 0.7)', '--- Theorem 1'},'Interpreter','latex', 'FontSize', 16);
grid on; box on;
...
outputFileName = 'Trajectory_f_PM_thm1_S6_0.6_0.7.pdf';
